...
module.exports = {
    ...
    getPulpits: async (args, context) => {
        let x = await getRecordsByField('Pulpit', args.pulpit, context)
        console.log(x);
        return x;
    },
    ...
    setPulpit: async (args, context) => {
        let fields = {
            Pulpit_Id: args.pulpit.pulpitId,
            Pulpit_Name: args.pulpit.pulpitName,
            Faculty: args.pulpit.facultyId
        };
    ...
    setSubject: async (args, context) => {
        let fields = {
            ...
            Subject_Name: args.subject.subjectName,
            Pulpit: args.subject.pulpitId
        };
        return mutateRecord('Subject', fields.Subject_Id, fields, context);
    },
    setTeacher: async (args, context) => {
        let fields = {
            Teacher_Id: args.teacher.teacherId,
            Teacher_Name: args.teacher.teacherName,
            Pulpit: args.teacher.pulpitId
        };
